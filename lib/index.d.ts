...
export interface ytdl {
     ...
     */
    (link:string, options?:DownloadOptions):Readable;

    /**
     * Use this if you only want to get metainfo from a video.
     */
    getInfo(url:string, callback:(err:any, info:VideoInfo) => void);

    /**
     * Use this if you only want to get metainfo from a video.
     */
    getInfo(url:string, options:DownloadOptions, callback:(err:any, info:VideoInfo) => void);
